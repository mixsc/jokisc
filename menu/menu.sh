...
Exp=$(curl -sS https://raw.githubusercontent.com/mixsc/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
clear
clear && clear && clear
clear;clear;clear
...
echo -e " ${PURPLE}└─────────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE} │ [0m ${BOLD}${PURPLE}     SSH      VMESS       VLESS      TROJAN $NC"
echo -e "${PURPLE} │ [0m ${Blue}      $ssh1         $vma           $vla           $tra $NC"
echo -e "${PURPLE} └─────────────────────────────────────────────────────┘${NC}"
...
echo -e " ${PURPLE}│  User          :[1;36m $Name \e[0m"
if [ $exp \< 1000 ];
then
